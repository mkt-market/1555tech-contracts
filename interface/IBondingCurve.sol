...
interface IBondingCurve {
    ...
    /// @param shareCountBondingCurve The number of shares in the bonding curve.
    /// @param amount The number of shares to buy or sell.
    function getPriceAndFee(uint256 shareCount, uint256 shareCountBondingCurve, uint256 amount) external view returns (uint256 price, uint256 fee);
